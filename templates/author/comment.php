...
<head>
    ...
    <title><?= $blog_name ?>上有人评论了您的文章。</title>
</head>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-block">
                                        <?= $comment->comment_author ?> 评论了你的文章「<a href="<?= get_permalink($post); ?>"><?= $post->post_title; ?></a>」。
                                    </td>
                                </tr>
                                <tr>
                                    <td class="content-block">
                                ...
                                <tr>
                                    <td class="content-block" itemprop="handler" itemscope itemtype="http://schema.org/HttpActionHandler">
                                        <a href="<?= get_comment_link( $comment ) ?>" class="btn-primary" itemprop="url">查看所有评论</a>
